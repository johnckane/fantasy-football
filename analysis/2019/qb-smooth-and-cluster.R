...
qb_smoothed_data$smoothed_cost <- predict(object = loess(data = qb_data, adj_value~ pos_adp),
                                          newdata = qb_smoothed_data)

qb_smoothed_data$smoothed_ppg <- predict(object = loess(data = qb_data, ppg ~ pos_adp),
                                                newdata = qb_smoothed_data)
qb_smoothed_data

# remove NA and one negative value for cost
qb_smoothed_data <- qb_smoothed_data[-c(29:32),]
qb_smoothed_data
