...
wr_smoothed_data$smoothed_cost <- predict(object = loess(data = wr_data, adj_value~ pos_adp),
                                          newdata = wr_smoothed_data)

wr_smoothed_data$smoothed_ppg <- predict(object = loess(data = wr_data, ppg ~ pos_adp),
                                         newdata = wr_smoothed_data)
wr_smoothed_data
