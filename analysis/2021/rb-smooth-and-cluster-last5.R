...
rb_smoothed_data$smoothed_cost <- predict(object = loess(data = rb_data, 
                                                         adj_value~ pos_adp,
                                                         span=0.25),
                                          newdata = rb_smoothed_data)

rb_smoothed_data$smoothed_ppg <- predict(object = loess(data = rb_data, 
                                                        ppg ~ pos_adp,
                                                        span=0.75),
                                         newdata = rb_smoothed_data)
...
save(rb_cluster_data,
     file = "/home/john/projects/fantasy-football/data/clustering-data/smoothed-and-clustered/rb_cluster_data_last5.Rda")
...
save(rb_single_obs_per_cluster,
     file = "/home/john/projects/fantasy-football/data/clustering-data/smoothed-and-clustered/rb_single_obs_per_cluster_last5.Rda")