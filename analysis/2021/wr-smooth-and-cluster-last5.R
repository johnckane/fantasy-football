...
save(wr_cluster_data,
     file = "/home/john/projects/fantasy-football/data/clustering-data/smoothed-and-clustered/wr_cluster_data_last5.Rda")
...
save(wr_single_obs_per_cluster,
     file = "/home/john/projects/fantasy-football/data/clustering-data/smoothed-and-clustered/wr_single_obs_per_cluster_last5.Rda")
